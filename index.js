...
// It is a limitation of the IMAP protocol, I believe,
// or at least of the `imap` module, that fetching
// messages from multiple boxes at the same time is
// simply not possible. In any case, using the `imap`
// module means that the sequence number starts drifting
// and other similarly confusing issues arise when
// multiple scans are allowed to occur at the same time.
